...
from InstanceGeneration.saa_generator import InstanceGenerator
...
def run_generation(sizes, n_instances, cv, num_scenarios, real=False):
    ...
    for size in sizes:
        for seed in range(n_instances):
            ...
            if real:
                ...
                scenarios, base_seed, scenario_seed   = generator.generate_scenarios(base, num_scenarios)
            
                instance = generator.build_solver_instance(base, scenarios, cv, size.value, base_seed)
